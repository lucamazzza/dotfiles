...
# -- Rosé Pine --
export BAR_COLOR=0x88101314;

export BASE_COLOR=0xff191724;
export TEXT_COLOR=0xffe0def4;

export LOVE_COLOR=0xffeb6f92;
export GOLD_COLOR=0xfff6c177;
export ROSE_COLOR=0xffebbcba;
export PINE_COLOR=0xff31748f;
export FOAM_COLOR=0xff9ccfd8;
export IRIS_COLOR=0xffc4a7e7;
